...
## Summary
Eastgate Station is the eastern rail and checkpoint complex where the Vale and Renn families attempt to leave New Babylonia in Chapter 1. It becomes the site of the first major rift attack shown in the current Book One manuscript.
...
- Blue station lamps along the platform
- Weather-beaten rail cars and heavy freight handling
- Crowded with passengers, porters, guards, inspectors, luggage, livestock cages, and tools during resettlement departures
- During the Chapter 1 attack, the platform is damaged by a collapsing bell tower, broken rail, frost, fire, shattered windows, and rift energy

## Population / Control
- Inspectors and guards control passage through the checkpoint
- Railway staff manage boarding, freight, and departure
- Inspector Vey is the named inspector encountered by the families
- Pell is the named conductor of Train Seven
- Exact institutional ownership of the station and chain of command remain undefined

## Risks
- High crowd density at a controlled chokepoint
- Gate closure can trap passengers inside the station complex
- Rail lines can be blocked by structural collapse
- Service passages can become creature access routes
- The Chapter 1 rift forms directly across the station pavement/rail area
