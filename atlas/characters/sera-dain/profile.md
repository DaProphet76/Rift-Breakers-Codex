...
- **Fears:** Losing personnel under her command; abandonment; emotional dependence
...
### Arc
- **Start:** Believes discipline, order, and doctrine can hold the docks together
- **Pressure:** A rift manifestation erupts during active garrison duty and exceeds normal security doctrine
- **Change:** Forced to improvise beyond procedure and place people ahead of institutional expectations
...
- **Active objectives:**
  - Secure the docks
  - Minimize civilian and unit casualties
...
### Header
- **Character Name:** Sera Dain
- **Player Name:** Yoshua Israel
- **Class & Level:** Fighter 4 (Battle Master)
- **Background:** Soldier
- **Race:** Human
- **Alignment:** Lawful Neutral (pressure toward Good)
- **Experience Points (XP):** 2700

### Core Combat
- **Armor Class (AC):** 16
- **Initiative:** +0
- **Speed:** 30 ft
- **Hit Point Maximum (HP Max):** 36
...
- **Proficiency Bonus:** +2
- **Inspiration:** 0
- **Saving Throws:** STR [x] DEX [ ] CON [x] INT [ ] WIS [ ] CHA [ ]
- **Skills:** Athletics, Intimidation, Perception, Insight
- **Passive Wisdom (Perception):** 14

### Attacks & Spellcasting
- **Attacks:** Service Rifle | +2 | 1d10 piercing | Mechanical reskin of heavy crossbow; Combat Knife | +3 | 1d4 piercing | close-range sidearm; Baton | +3 | 1d4 bludgeoning | restraint / control tool
- **Spellcasting:** N/A
...
- Growth Log File: `atlas/characters/sera-dain/growth.md`
