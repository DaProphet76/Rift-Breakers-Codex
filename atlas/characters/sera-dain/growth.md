...
- **Intro Story Point:** Chapter 04 — Dock Outpost introduction sequence
- **Starting Level:** Fighter 4 (Battle Master)
...
### Chapter/Batch: Chapter 04 — Dock Rift Event
- **Story Event Summary:**
  - Sera is on active duty at the Outer Ring Dock Outpost when a rift manifestation disrupts normal security conditions.
  - Standard perimeter doctrine becomes insufficient as the threat behaves outside familiar military expectations.
  - Sera is forced to make immediate decisions involving soldiers, civilians, and an unstable perimeter.
- **Growth / Change:** Her confidence in procedure begins to fracture as she is forced to improvise and prioritize people over doctrine.
- **Reveal(s):** The institution cannot guarantee the safety or truth it presents itself as controlling.
